...
def cast_num_frames(t, *, frames):
    """
    For training num_frames will always be two, this ensures that 
    we operate on an uneven number of frames
    """
    f = t.shape[1]
    if f%frames==0:
        return t[:,:-(frames-1)]
...
# for pretraining on images => greater sample efficiency
...
def seek_all_images(img, channels = 3):
    """
    Seeks all images that are part of a gif with PIL.Image.seek()
    """
...
class VideoDataset(Dataset):
    ...
    # TODO: Adjust to synthrad & Supplementary datasets
...
# TODO: Adjust to collate Images & Embeddings (Not needed for encoder training)
